...
import ch.bfh.sed.commandpattern.action.CutAction;


/**
 * Invoker for the 'cut' action performed by the user.
 *
 * @author Eric Dubuis
 */
public class CutInvoker extends CutAction {
	...
	/**
	 * Given an editor, create a macro command which contains cut commands for
	 * each selected shape which in turn contain the editor and a shape. The
	 * selected shapes can be obtained by calling getSelection() on the given
	 * editor instance. Must be the first method being called upon an instance
	 * of this class.
	 *
	 * @param e
	 *            the editor
