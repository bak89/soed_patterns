...
import ch.bfh.due1.jdt.simple.impl.alignment.AlignLeftStrategy;
...
/**
 * Test class for the lesft align strategy.
 * 
 * @author Eric Dubuis
 */
public class AlignLeftStrategyTest {
	...
	/**
	 * Tests if the left alignment of an empty selection has no effect of the
	 * empty selection.
	 */
	@Test
	public void testAlign0() {
		List<Shape> selectedShapes = new ArrayList<Shape>();
		AlignStrategy strategy = new AlignLeftStrategy();
	...
	/**
	 * Tests if the left alignment of a selection with one shape only has no
	 * effect.
	 */
	@Test
	...
	/**
	 * Tests if the left alignment of three boxes aligns the other boxes to the
	 * first one.
	 */
	@Test
	...
	public void testAlign2d() {
		...
		Shape box3 = new SimpleBox(10, 10, 10, 30);
		List<Shape> selectedShapes = new ArrayList<Shape>();
		selectedShapes.add(box1);
		selectedShapes.add(box2);
		selectedShapes.add(box3);
