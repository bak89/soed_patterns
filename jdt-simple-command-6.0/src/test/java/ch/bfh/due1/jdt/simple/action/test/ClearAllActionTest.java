...
import ch.bfh.due1.jdt.simple.action.ClearAllAction;
...
public class ClearAllActionTest {
	...
	/**
	 * Test if newly created 'clear all action' is disabled.
	 */
	@Test
	public void testCreateClearAllAction1() {
		BaseAction a = new ClearAllAction();
		assertFalse(a.isEnabled());
	}

	/**
	 * Test if newly created 'clear all action' is still disabled
	 * after calling checkAction().
	 */
	@Test
	public void testCreateClearAllAction2() {
		BaseAction a = new ClearAllAction();
	...
	/**
	 * Test if newly created 'clear all action' is enabled when editor
	 * has shapes and after calling checkAction().
	 */
	@Test
	public void testCreateClearAllAction3() {
		BaseAction a = new ClearAllAction();
		Editor e = new MockEditor();
