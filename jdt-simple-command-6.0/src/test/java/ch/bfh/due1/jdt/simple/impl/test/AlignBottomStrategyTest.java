...
import ch.bfh.due1.jdt.simple.impl.alignment.AlignBottomStrategy;
...
/**
 * Test class for the bottom align strategy.
 * 
 * @author Eric Dubuis
 */
public class AlignBottomStrategyTest {
	...
	/**
	 * Tests if the bottom alignment of an empty selection has no effect of the
	 * empty selection.
	 */
	@Test
	public void testAlign0() {
		List<Shape> selectedShapes = new ArrayList<Shape>();
		AlignStrategy strategy = new AlignBottomStrategy();
	...
	/**
	 * Tests if the bottom alignment of a selection with one shape only has no
	 * effect.
	 */
	@Test
	...
	/**
	 * Tests if the bottom alignment of three boxes aligns the other boxes to
	 * the first one.
	 */
	@Test
	...
	public void testAlign2d() {
		...
		assertEquals(new BoundingBox(10, 10, 10, 10), selectedShapes.get(0)
				.getBoundingBox());
		assertEquals(new BoundingBox(10, 0, 10, 20), selectedShapes.get(1)
				.getBoundingBox());
	...
	public void testAlign3() {
		Shape box1 = new SimpleBox(10, 10, 10, 10);
		Shape box2 = new SimpleBox(10, 0, 10, 20);
		Shape box3 = new SimpleBox(10, 10, 10, 30);
		List<Shape> selectedShapes = new ArrayList<Shape>();
		selectedShapes.add(box1);
		selectedShapes.add(box2);
