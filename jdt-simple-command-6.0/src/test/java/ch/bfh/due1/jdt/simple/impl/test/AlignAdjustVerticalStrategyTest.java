...
import ch.bfh.due1.jdt.simple.impl.alignment.AlignJustifyVerticalStrategy;
 ...
 * @author Eric Dubuis
 */
public class AlignAdjustVerticalStrategyTest {
	...
	/**
	 * Tests if the justify vertical alignment of an empty selection has no
	 * effect of the empty selection.
	 */
	@Test
	public void testAlign0() {
		List<Shape> selectedShapes = new ArrayList<Shape>();
		AlignStrategy strategy = new AlignJustifyVerticalStrategy();
	...
	/**
	 * Tests if the justify vertical alignment of a selection with one shape
	 * only has no effect.
	 */
	@Test
	...
	/**
	 * Tests if the justify vertical alignment of three boxes aligns the other
	...
	public void testAlign2b() {
		Shape box1 = new SimpleBox(0, 10, 10, 10);
		...
		AlignTool t = new AlignTool(e);
		strategy.align(t, selectedShapes);
		assertEquals(new BoundingBox(0, 10, 10, 10), selectedShapes.get(0)
				.getBoundingBox());
		assertEquals(new BoundingBox(0, 10, 10, 10), selectedShapes.get(1)
				.getBoundingBox());
		assertEquals(new BoundingBox(0, 10, 10, 10), selectedShapes.get(2)
				.getBoundingBox());
	}
	...
	public void testAlign2d() {
		Shape box1 = new SimpleBox(10, 10, 10, 10);
		Shape box2 = new SimpleBox(10, 10, 30, 10);
		Shape box3 = new SimpleBox(10, 10, 50, 10);
		List<Shape> selectedShapes = new ArrayList<Shape>();
		selectedShapes.add(box1);
		selectedShapes.add(box2);
		selectedShapes.add(box3);
		...
		assertEquals(new BoundingBox(10, 10, 10, 10), selectedShapes.get(0)
				.getBoundingBox());
		assertEquals(new BoundingBox(0, 10, 30, 10), selectedShapes.get(1)
				.getBoundingBox());
		assertEquals(new BoundingBox(-10, 10, 50, 10), selectedShapes.get(2)
				.getBoundingBox());
	}
