...
import ch.bfh.due1.jdt.simple.impl.alignment.AlignTopStrategy;
import ch.bfh.due1.jdt.simple.impl.shape.SimpleBox;

/**
 * Test class for the top align strategy.
 * 
 * @author Eric Dubuis
 */
public class AlignTopStrategyTest {
	...
	/**
	 * Tests if the top alignment of an empty selection has no effect of the
	 * empty selection.
	 */
	@Test
	public void testAlign0() {
		List<Shape> selectedShapes = new ArrayList<Shape>();
		AlignStrategy strategy = new AlignTopStrategy();
	...
	/**
	 * Tests if the top alignment of a selection with one shape only has no
	 * effect.
	 */
	@Test
	...
	/**
	 * Tests if the top alignment of three boxes aligns the other boxes to the
	 * first one.
	 */
	@Test
