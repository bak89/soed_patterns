...
public class RunningTest {
	...
	public void testHandleB1() throws Exception {
		stopWatch.setState(stateFactory.createRunningState(stopWatch));
		stopWatch.button1Pressed();
		assertEquals(stateFactory.createIntermediateState(stopWatch), stopWatch.getState());
		assertTrue(stopWatch.isDisplayingIntermediateTime());
	}
