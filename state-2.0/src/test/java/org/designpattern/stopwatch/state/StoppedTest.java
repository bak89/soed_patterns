...
public class StoppedTest {
	...
	public void testHandleB2() throws Exception {
		...
		assertEquals(stateFactory.createIdleState(stopWatch), stopWatch.getState());
		assertTrue(stopWatch.isTimerReset());
		assertTrue(stopWatch.isDisplayingZero());
	}
}
