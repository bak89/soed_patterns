 ...
 * @author Eric Dubuis
 */
public class SerializableReservation implements Reservation, Serializable {
	private static final long serialVersionUID = -6591213564088715491L;
	 ...
	 */
	SerializableReservation(Set<Resource> rs, Person p, DateRange dr) {
		this.resources = rs;
		this.owner = p;
		this.dr = dr;
	}
