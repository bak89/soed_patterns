...
/**
 * Default handle at the north-east position of a shape.
 * 
 * @author Eric Dubuis
 */
public class DefaultNEHandle extends AbstractHandle {
	/**
	 ...
	 */
	public DefaultNEHandle(Shape owner, Coord location) {
	...
	public void dragInteraction(Coord c, KeyModifier k) {
		...
		BoundingBox modified = new BoundingBox(r.getX0(), c.getY0(),
				c.getX0() - r.getX0(), r.getY0() - c.getY0()
						+ r.getHeight());
