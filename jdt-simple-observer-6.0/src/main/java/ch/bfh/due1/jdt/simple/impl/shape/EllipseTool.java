...
/**
 * Implementation of a tool for creating ellipses.
 *
 * @author Eric Dubuis
 */
public class EllipseTool extends DefaultTool {

	private SimpleEllipse shapeConstructing = null;

	/**
	 * Creates an ellipse tool.
	 *
	 * @param e
	 *            The associated editor.
	 */
	public EllipseTool(Editor e) {
		super(e);
	}

	/**
	 * Constructs an ellipse at the given point (x, y) with initial size of
	 * zero. Installs the shape on the sheet associated with the current view of
	 * the editor.
	 *
	...
	public void mouseDown(Coord c, KeyModifier k) {
		...
		this.shapeConstructing = new SimpleEllipse(c.getX0(), c
				.getY0(), 0, 0);
	...
	/**
	 * Enlarges the ellipse relative to the origin point (x0, y0) and the
	 * current point (x, y).
	 *
