...
/**
 * Implementation of a tool for creating boxes.
 *
 * @author Eric Dubuis
 */
public class BoxTool extends DefaultTool {

	private SimpleBox shapeConstructing = null;

	/**
	 * Creates a box tool instance.
	 *
	 * @param e
	 *            The associated editor.
	 */
	public BoxTool(Editor e) {
		super(e);
	}

	/**
	 * Constructs a box at the given point (x, y) with initial size of zero.
	...
	public void mouseDown(Coord c, KeyModifier k) {
		...
		this.shapeConstructing = new SimpleBox(c.getX0(), c.getY0(),
				0, 0);
	...
	/**
	 * Enlarges the box relative to the origin point (x0, y0) and the current
	 * point (x, y).
	 *
