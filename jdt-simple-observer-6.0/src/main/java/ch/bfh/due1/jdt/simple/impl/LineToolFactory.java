...
import ch.bfh.due1.jdt.simple.impl.shape.LineTool;


/**
 * A factory returning a tool for creating lines.
 * 
 * @author Eric Dubuis
 */
public class LineToolFactory extends ToolFactory {
	/**
	 * Returns a line tool.
	 * 
