...
/**
 * Default handle at the north-west position of a shape.
 * 
 * @author Eric Dubuis
 */
public class DefaultNWHandle extends AbstractHandle {
	/**
	 ...
	 */
	public DefaultNWHandle(Shape owner, Coord location) {
