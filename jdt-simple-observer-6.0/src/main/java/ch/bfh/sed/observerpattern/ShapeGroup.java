...
public class ShapeGroup extends AbstractShape {
	...
	private class NHandle extends AbstractHandle {
		/**
	 ...
	 *
	 * @see AbstractShape#doDrawShape(Graphics)
	 */
	@Override
	 ...
	 *
	 * @see Shape#setBoundingBox(BoundingBox)
	 */
	@Override
	...
	/**
	 *
	 * @see AbstractShape#getShapeHandles()
	 */
	@Override
	 ...
	 * child mementos contained in the given memento to reset the group's
	 * children, and by setting the current bounding box by the bounding box
	 * contained in the memento.
	 * <p>
	 * FIXME Add mechanism that avoids shape listener storms.
	 *
	 * @see Shape#setMemento(Memento)
	 */
	@Override
