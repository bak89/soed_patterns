...
public class SimpleBoxTest {
	...
	/**
	 * Creates a simple box and tests the size of its expected bounding box.
	 */
	@Test
	public void testCreate1() {
		Shape box = new SimpleBox(0, 0, 10, 10);
		BoundingBox expected = new BoundingBox(0, 0, 10, 10);
		assertEquals(expected, box.getBoundingBox());
	}

	/**
	 * Creates a simple box, sets a new bounding box, and tests the size of its
	 * expected bounding box.
	 */
	@Test
	public void testSetBoundingBox1() {
		Shape box = new SimpleBox(10, 0, 10, 10);
	...
	/**
	 * Test whether the created memento restores the box.
	 */
	@Test
	public void testMemento() {
		Shape s = new SimpleBox(10, 20, 30, 40);
