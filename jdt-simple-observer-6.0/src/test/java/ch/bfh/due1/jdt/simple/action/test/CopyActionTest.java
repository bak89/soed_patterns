...
import ch.bfh.due1.jdt.simple.action.CopyAction;
...
public class CopyActionTest {
	...
	/**
	 * Test if newly created 'copy action' is disabled.
	 */
	@Test
	public void testCreateCopyAction1() {
		BaseAction a = new CopyAction();
		assertFalse(a.isEnabled());
	}

	/**
	 * Test if newly created 'copy action' is still disabled
	 * after calling checkAction().
	 */
	@Test
	public void testCreateCopyAction2() {
		BaseAction a = new CopyAction();
	...
	/**
	 * Test if newly created 'copy action' is still disabled when editor
	 * has shapes and after calling checkAction().
	 */
	@Test
	public void testCreateCopyAction3() {
		BaseAction a = new CopyAction();
		Editor e = new MockEditor();
	...
	/**
	 * Test if newly created 'copy action' is enabled when editor
	 * has selected shapes and after calling checkAction().
	 */
	@Test
	public void testCreateCopyAction4() {
		BaseAction a = new CopyAction();
		Editor e = new MockEditor();
